...
<Accordion client:visible title="Why should you need to do this?">
...
<Accordion client:visible title="How can I adjust Horizontal centering">
...
<Accordion client:visible title="Should you use Negative margin?">
...
<Youtube client:visible id="C0DPdy98e4c" title="Play:Youtube" />
