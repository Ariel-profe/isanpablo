...
service:
  homepage_tab:
    title: Formación integral para una convivencia armónica
    description: Nuestro modelo pedagógico se fundamenta en el desarrollo de competencias académicas, éticas y espirituales.
    tab_list:
  ...
  our_service:
    - title: Formación académica de excelencia internacional
      ...
      list:
        ...
        - Docentes especializados en educación religiosa
