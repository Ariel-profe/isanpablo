  ...
  return (
    <section className='container mx-auto mt-32'>
        ...
        <CarouselPage images={primaria.images}/>
            <div className='px-3'>
                <p className='text-xl md:text-2xl text-primary-dark-gray mt-12 text-justify'>{primaria.description}</p>
            ...
            <div className='my-12 px-3'>
                ...
                <p className='text-lg md:text-xl text-primary-dark-gray my-5 text-justify'>Para una mejor organización y atención de calidad en las consultas, tanto de docentes como de directivos, se recomienda a los padres solicitar con anticipación sus entrevistas y esperar la confirmación de la misma.</p>
