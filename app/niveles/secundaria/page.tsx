      ...
      <BlurTitle word="Nivel Secundario" />
        <div className='mt-10'>
          <CarouselPage images={secundaria.images}/>
            <div className='px-3 mb-10 lg:mb-20'>
                <p className='text-lg md:text-2xl text-primary-dark-gray mt-12 text-justify'>{secundaria.description}</p>
            ...
            <div className='my-12 px-3'>
                ...
                <p className='text-xl text-primary-dark-gray my-5'>Para una mejor organización y atención de calidad en las consultas, tanto de docentes como de directivos, se recomienda a los padres solicitar con anticipación sus entrevistas y esperar la confirmación de la misma.</p>
